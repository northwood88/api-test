...
public class DGTTestTemplate extends WebUITestTemplate {
	...
	LoginPage loginPage0 = (LoginPage) goToPageByURL(context, "https://dev-lion-tools.lion.eac.ad.ea.com/", LoginPage.class);
		...
		log("enter user name");
		Object keysToSend541900 = username;
		if (keysToSend541900 instanceof Double) {
			keysToSend541900 =  Double.toString( (Double) keysToSend541900);
		}
		
		interactions.sendKeys(loginPage0.username, (String) keysToSend541900);
	
		log("enter password");
		Object keysToSend031300 = password;
		if (keysToSend031300 instanceof Double) {
			keysToSend031300 =  Double.toString( (Double) keysToSend031300);
		}
		
		interactions.sendKeys(loginPage0.password, (String) keysToSend031300);
	...
	JasfApiClientPage jasfApiClientPage0 = (JasfApiClientPage) goToPageByURL(context, "https://dev-lion-tools.lion.eac.ad.ea.com/apiclient", JasfApiClientPage.class);
		...
		Object keysToSend494500 = urlPath;
		if (keysToSend494500 instanceof Double) {
			keysToSend494500 =  Double.toString( (Double) keysToSend494500);
		}
		
		interactions.sendKeys(jasfApiClientPage0.textInputUrlPath, (String) keysToSend494500);
		...
		String[] sValues013100 = resultS1Body.split("=");
		verifications.verifyAttribute(jasfApiClientResultsPage1.s1Body, sValues013100[0], sValues013100[1], "Verify server 1 body", null);
